...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.6]{implementation_and_testing/calendar_manager/path.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.6]{implementation_and_testing/calendar_manager/event.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.5]{implementation_and_testing/app_server_I&T.png}
	\end{center}
