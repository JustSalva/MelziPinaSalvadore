\begin{center}
	...
	\end{longtable}
\end{center}
The \textit{Notification Manager} is used to satisfy the requirements above and also to warn the user when a strike is announced or when the weather forecasts for the following days are adverse.\\\\
