...
\begin{itemize}
	...
	\item Head to \path{'your Glassfish Main Folder'\glassfish\domains\domain1\autodeploy} and copy in this folder the ApplicationServerArchive.war (\href{https://github.com/JustSalva/MelziPinaSalvadore/tree/master/DeliveryFolder/InstallationFolder}{\color{blue}link});
...
\begin{itemize}
	\item Download the APK of Travlendar+ from here (substitute here with link); \todo{TODO}
