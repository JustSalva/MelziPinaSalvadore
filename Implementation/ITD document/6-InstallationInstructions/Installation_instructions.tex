This chapter provide all useful information to install and run our software. We will be very verbose and we will present some alternative ways to run and test our project.\\
However we think that the easier way to test our system is just using our Android app. \\
Please take into consideration that we have properly tested our app selecting locations that are in Milan's surrounding and more generally in Lombardy (Italy).
...
\begin{itemize}
	...
	\item Head to \path{'your Glassfish Main Folder'\glassfish\domains\domain1\autodeploy} and copy in this folder the ApplicationServerArchive.war file: \href{https://github.com/JustSalva/MelziPinaSalvadore/tree/master/DeliveryFolder/InstallationFolder}{\color{blue}link};
...
\subsection{Instructions to run the App on your Android device}
