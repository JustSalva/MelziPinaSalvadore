...
\label{subsect:Sequence diagrams}
	\subsubsection{Login}
		\includegraphics[scale=0.3]{sequence_diagrams/login.jpg}
	\subsubsection{Create event}
		\includegraphics[scale=0.3]{sequence_diagrams/create_event.jpg}
	\subsubsection{Arrange trip}
		\includegraphics[scale=0.3]{sequence_diagrams/arrange_trip.jpg}
	\subsubsection{Obtain feasible paths}
		\includegraphics[scale=0.3]{sequence_diagrams/obtain_feasible_paths.jpg}
	\subsubsection{Choose between overlapping events}
		\includegraphics[scale=0.3]{sequence_diagrams/choose_between_overlapping_events.jpg}